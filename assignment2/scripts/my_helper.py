...
class MyHelper:
    ...
    # def LoadOntology(self,client, path):
    #
    #     ##
    ...
    #     while counter < 2:
    #         # ADD ALL OUR AXIOMS
    #         if(client.manipulation.add_ind_to_class("R1", "LOCATION") and once == 1):
    #             print("Added R1 to LOCATION" , end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("R2", "LOCATION")and once == 1):
    #             print("Added R2 to LOCATION", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("R3", "LOCATION")and once == 1):
    #             print("Added R3 to LOCATION", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("R4", "LOCATION")and once == 1):
    #             print("Added R4 to LOCATION", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("C1", "LOCATION")and once == 1):
    #             print("Added C1 to LOCATION", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("C2", "LOCATION")and once == 1):
    #             print("Added C2 to LOCATION", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("E", "LOCATION")and once == 1):
    #             print("Added E to LOCATION", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("D1", "DOOR")and once == 1):
    #             print("Added D1 to DOOR", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("D2", "DOOR")and once == 1):
    #             print("Added D2 to DOOR", end='\r')
    #         if(client.manipulation.add_ind_to_class("D3", "DOOR")and once == 1):
    #             print("Added D3 to DOOR", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("D4", "DOOR")and once == 1):
    #             print("Added D4 to DOOR", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("D5", "DOOR")and once == 1):
    #             print("Added D5 to DOOR", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("D6", "DOOR")and once == 1):
    #             print("Added D6 to DOOR", end='\r')
    #             time.sleep(0.5)
    #         if(client.manipulation.add_ind_to_class("D7", "DOOR")and once == 1):
    #             print("Added D7 to DOOR", end='\r')
    #             time.sleep(0.5)
    ...
    #
    #         if(once == 1):
    #             if(client.manipulation.add_dataprop_to_ind("visitedAt", "R1", 'Long', str(int(time.time())))):
    #                 print("Added timestamp to R1", end='\r')
    #                 #time.sleep(0.5)
    ...
    def NewLoadOntology(self,client, path):
    ...
    def NewLoadOntologyCallback(self, room_msg):
        roomL = []
        roomL.append(room_msg)
        for i in range(len(roomL)):
            print(roomL[i])


    def Reasoning(self, client):
    ...
    def UpdateNowRobot(self, client):
    ...
    def UpdateVisitedRoom(self, client, room):
    ...
    def GetUrgentRooms(self, client):
        ##
    ...
    def GetReachableRooms(self, client):
        ##
    ...
    def MoveRobot(self, client, newRoom):
        ##
