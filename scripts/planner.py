...
# \file planner.py
# \brief This file simulates the behaviour of the robot while planning to a location
...
# `my_helper` node, and return a plan as a set of via points.
#
...
class PlaningAction(object):
    ...
    ##
    # \class PlaningAction
    # \brief This class defines the planner
    #
    ...
    def __init__(self):
        ...
        ##
        # \brief This function is the constructor of the robot's planner class
        # \param None
        # \return None
        #
        # This function implements the constructor of the planner and also instantiates the ActionServer of it
        #
        ...
        self._environment_size = [10.0, 10.0]
        ...
        self._as.start()
        # Log information.
        log_msg = (f'NODE_PLANNER Action Server initialised. It will create random path with a number of point '
    ...
    def execute_callback(self, goal):
        ##
        # \brief This function is the callback of the robot's planner class
        # \param goal
        # \return None
        #
        ...
        # is the current robot position (retrieved from the `my_helper` node), while the last
    ...
    def _is_valid(self, point):
        ...
        ##
        # \brief This function checks if goal is valid
        # \param None
        # \return coordinates x and y generated
        #
...
def _get_pose_client():
    ...
    ##
    # \brief This function gets the pose of the robot
    # \param None
    # \return pose obtained
    #
    # Retrieve the current robot pose by the `state/get_pose` server of the `my_helper` node.
    #
...
if __name__ == '__main__':
    ...
    rospy.init_node('NODE_PLANNER', log_level=rospy.INFO)
